...
AJAX.get("../server/getDetail.php", {
    ...
    if (!data.error) {
        ...
        <div class="box">
              ...
              <div class="show">
                <img src="https://img01.hua.com/uploadpic/newpic/${data.data.ItemCode}.jpg_220x240.jpg" alt="">
                <div class="mask"></div>
              </div>
              <div class="list">
                <p class="active">
                  <img
                    src="https://img01.hua.com/uploadpic/newpic/${data.data.ItemCode}.jpg_220x240.jpg"
                    showImg="https://img01.hua.com/uploadpic/newpic/${data.data.ItemCode}.jpg_220x240.jpg"
                    enlargeImg="https://img01.hua.com/uploadpic/newpic/${data.data.ItemCode}.jpg_220x240.jpg"
                    alt="">
                </p>
                <p>
                  <img
  ...
  <div class="media">
      <div class="media-body">
          <h4 class="media-heading">浪漫心情--${data.data.Instro}</h4>
          <h5>火热玫瑰  幸福告白</h5>
          <div class="box1">
              <p>类 别：鲜花编号：${data.data.ItemCode}</p>
              <p>材 料： ${data.data.Instro}</p>
    ...
    home.innerHTML = data.data.Introduce;
